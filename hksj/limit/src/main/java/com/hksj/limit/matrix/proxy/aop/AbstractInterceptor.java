...
import com.hksj.limit.matrix.proxy.constant.ProxyConstant;
import com.hksj.limit.matrix.proxy.exception.ProxyException;
import com.hksj.limit.matrix.proxy.util.ProxyUtil;
...
public abstract class AbstractInterceptor implements MethodInterceptor {
    ...
    // 通过解析字节码文件的本地变量表来获取的，只支持 CGLIG(ASM library)，适用于类代理
